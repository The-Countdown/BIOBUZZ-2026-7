...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "IMUCalibration", group = "Teleop")
public class IMUCalibration extends OpMode {
    ...
    public void init() {
        ...
        parameters.loggingTag     = "betterIMU";
        imu = hardwareMap.get(BNO055IMU.class, "betterIMU");
