...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp(name = "IMUCalibration2", group = "Teleop")
public class IMUCalibration2 extends OpMode {
    BNO055IMU imu;
    ...
    public void init() {
        ...
        parameters.loggingTag     = "betterIMU2";
        imu = hardwareMap.get(BNO055IMU.class, "betterIMU2");
    ...
    public void loop() {
        if (gamepad1.a) {
            ...
            String filename = "AdafruitIMUCalibration2.json";
