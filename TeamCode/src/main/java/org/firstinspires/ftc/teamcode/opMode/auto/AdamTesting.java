...
@Autonomous(name = "AdamTesting", group = "Autonomous")
@Configurable // Panels
    public class AdamTesting extends OpMode {
        ...
        public void loop() {
            ...
            panelsTelemetry.debug("Flywheel At Target", robotContainer.turret.flywheel.atTargetVelocity());
            ...
            panelsTelemetry.addData("Flywheel Error", robotContainer.turret.flywheelError);
            panelsTelemetry.addData("Flywheel Target", robotContainer.turret.flywheel.targetVelocity);
            panelsTelemetry.addData("Flywheel Current", robotContainer.turret.flywheel.getFlywheelVelocity());
            ...
            switch (pathState) {
                case 0:
                    ...
                    if (pathTimer.milliseconds() > SHOOTING_TIME && actionRun) {
                        follower.followPath(paths.BF_HW, false);
                        incrementPathState();
                    }
                    break;
                case 1:
                ...
                case 3:
                    if (!follower.isBusy()){
                        //intake.run();
                        follower.followPath(paths.SF_HS_1, false);
                        incrementPathState();
                    }
                    break;
                case 4:
                ...
                case 6:
                    if (!follower.isBusy()){
                        //intake.run();
                        follower.followPath(paths.SF_HS_2, false);
                        incrementPathState();
                    }
                    break;
                case 7:
                ...
                case 9:
                    if (!follower.isBusy()){
                        //intake.run();
                        follower.followPath(paths.SF_HS_3, false);
                        incrementPathState();
                    }
                    break;
                case 10:
