...
@Autonomous(name = "12Close", group = "Autonomous")
@Configurable // Panels
public class TwelveClose extends OpMode {
    private TelemetryManager panelsTelemetry; // Panels Telemetry instance
    public Follower follower; // Pedro Pathing follower instance
    private RobotContainer robotContainer;
    private int pathState; // Current autonomous path state (state machine)
    private TwelveClose.Paths paths; // Paths defined in the Paths class
    ...
    public void init() {
        ...
        paths = new TwelveClose.Paths(follower); // Build paths
        holding = false;
        actionRun = false;
...
//                Status.flywheelToggle = true;
    ...
    private static class Paths {
        ...
        public Pose
                ...
                RED_GATE = new Pose(122.000, 66.000, Math.toRadians(0)),
                RED_GATE_COLLECT = new Pose(126.000, 57, Math.toRadians(40)),
